...
from .face_utils import unpack_resolution, resize_frame_resolution, warp_face_by_translation, get_first, \
...
def get_many_faces(vision_frame, nets, min_score, order='left-right'):
    faces = []
    try:
